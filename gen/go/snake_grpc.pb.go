...
const (
	InferenceService_Predict_FullMethodName = "/snake.InferenceService/Predict"
)
...
type InferenceServiceClient interface {
	Predict(ctx context.Context, in *InferenceRequest, opts ...grpc.CallOption) (*BatchInferenceResponse, error)
}
...
func (c *inferenceServiceClient) Predict(ctx context.Context, in *InferenceRequest, opts ...grpc.CallOption) (*BatchInferenceResponse, error) {
...
type InferenceServiceServer interface {
	Predict(context.Context, *InferenceRequest) (*BatchInferenceResponse, error)
...
func (UnimplementedInferenceServiceServer) Predict(context.Context, *InferenceRequest) (*BatchInferenceResponse, error) {
...
var InferenceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "snake.InferenceService",
